...
export const mockIntegrations: Integration[] = [
  ...
  { id: "int-4", name: "Salesforce", description: "Referral tracking, patient journey analytics, CRM pipeline", status: "connected", lastSync: "2026-02-04T10:20:00", icon: "Cloud", category: "crm" },
  { id: "int-5", name: "Zendesk", description: "Ticket creation for incomplete referrals, missing items tracking", status: "connected", lastSync: "2026-02-04T10:22:00", icon: "LifeBuoy", category: "crm" },
