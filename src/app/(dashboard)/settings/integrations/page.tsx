...
const STATUS_CONFIG = {
  ...
  disconnected: { label: "Disconnected", color: "bg-gray-100 text-gray-500", icon: XCircle },
              ...
              <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div className={cn("flex h-10 w-10 items-center justify-center rounded-lg", integration.status === "connected" ? "bg-emerald-50" : "bg-muted")}>
