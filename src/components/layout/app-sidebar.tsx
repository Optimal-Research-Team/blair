...
const navGroups = [
  {
    ...
    items: [
      ...
      { title: "Worklist", href: "/worklist", icon: "ListTodo" as const, badgeCount: 8, badgeColor: "bg-amber-500" },
      { title: "Referrals", href: "/referrals", icon: "FileHeart" as const },
      { title: "Communications", href: "/communications", icon: "Send" as const },
    ],
  },
  {
    title: "Analytics",
